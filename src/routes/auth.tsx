...
function AuthPage() {
  ...
  const [tab, setTab] = useState<"signin" | "signup">(search.tab);
      ...
      >
        ...
        <div>
          ...
          <p className="mt-4 max-w-md text-muted-foreground">
            Sign in to manage payments, visitors, security updates and announcements for your home.
          </p>
        </div>
        <p className="text-xs text-muted-foreground">© {new Date().getFullYear()} Oyesile Estate</p>
      </div>
